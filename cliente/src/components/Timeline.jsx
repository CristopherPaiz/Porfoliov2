  ...
  return (
    <div className="w-full m-auto flex justify-center mt-24">
      <div className=" sm:mx-32 mb-12 shadow-lg dark:shadow-2xl px-4 py-0 rounded-3xl max-w-[1200px] w-full">
            ...
            {estudios.map((estudio, index) => (
              <li key={index} className="mb-16 ml-7 sm:ml-10">
                ...
                {estudio?.estado === false && (
                  <>
                    <span className="bg-blue-100 text-center text-blue-800 text-tiny font-medium px-3 rounded py-1 dark:bg-yellow-200 dark:text-black">
        ...
        <h1
          className={`text-4xl text-center mt-36 mb-10 sm:text-left sm:mx-5 sm:text-6xl font-black sm:mt-24 ${
            theme === "dark" ? "claro" : "oscuro"
          }`}
        >
          Certificados, cursos
