...
const Timeline = () => {
  ...
  const calcularDiferenciaFechas = (fecha) => {
    ...
    return `Antigüedad desde la fecha de finalizado: ${años} años, ${meses} meses, ${dias} días.`;
  };
  ...
  return (
    <div className="sm:mx-32 mb-12 shadow-lg dark:shadow-2xl px-4 py-0 rounded-3xl">
      ...
      <div className="my-6 mx-10">
        <ol className="relative border-l border-gray-200 dark:border-gray-700">
          {estudios.map((estudio, index) => (
            <li key={index} className="mb-10 ml-7 sm:ml-10">
              ...
              <time
                className={`flex flex-row gap-x-2 mt-3 sm:text-lg font-normal leading-snug text-gray-400 dark:text-gray-500 ${
                  theme === "dark" ? "claro" : "oscuro"
                }`}>
              ...
              <time className="flex-col">
                <div className="flex flex-row gap-x-2 sm:text-lg font-normal leading-snug text-gray-400 dark:text-gray-500">
              ...
              <time
                className={`flex flex-row gap-x-2 sm:text-lg font-normal leading-snug capitalize text-gray-400 dark:text-gray-500 ${
                  theme === "dark" ? "claro" : "oscuro"
                }`}>
      ...
      <h1
        className={`text-5xl text-center mt-12 sm:text-left sm:mx-5 sm:text-5xl font-black sm:mt-12 ${
          theme === "dark" ? "claro" : "oscuro"
        }`}>
        Certificados, cursos
      </h1>
