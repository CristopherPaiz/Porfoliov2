...
const estudios = [
  {
    titulo: "Ingeniería en Sistemas y Ciencias de la Computación 10° semestre",
...
const Timeline = () => {
  ...
  const formatearFecha = (fecha) => {
    const mes = fecha.toLocaleString("default", { month: "short", timeZone: "UTC" });
  ...
  const calcularDiferenciaFechas = (fecha) => {
    ...
    return `Antigüedad: ${años} años, ${meses} meses.`;
  };
  ...
  const calcularDiferenciaFechaspequenio = (fecha) => {
    ...
    if (años > 0) {
      return `Hace: ${años} años, ${meses} meses.`;
    }
    if (meses > 0) {
  ...
  return (
    <div className="w-full m-auto flex justify-center mt-24">
      <div className=" sm:mx-32 mb-12 shadow-lg dark:shadow-2xl px-4 py-0 rounded-3xl max-w-[1200px] w-full">
        <h1
          className={`pt-5 text-5xl text-center mt-24 mb-10 sm:text-left sm:mx-5 sm:text-6xl font-black sm:mt-32 ${
            theme === "dark" ? "claro" : "oscuro"
          }`}
        >
          Educación
        </h1>
        <div className=" sm:pl-14 my-6 mx-10">
          <ol className="relative border-l border-gray-200 dark:border-gray-700">
            {estudios.map((estudio, index) => (
              <li key={index} className="mb-14 ml-5 sm:ml-10">
                <span className="absolute flex items-center justify-center w-6 h-6 bg-yellow-100 rounded-full -left-3 ring-8 ring-blue-100 dark:ring-blue-900 dark:bg-yellow-900">
                  <svg
                ...
                <h3 className="flex items-center sm:text-xl font-black">
                ...
                {estudio?.estado === false && (
                  <>
                    <span className="bg-orange-100 text-center text-black text-tiny font-medium px-3 rounded py-1 dark:bg-orange-800 dark:text-white">
                ...
                <time
                  className={`flex flex-row gap-x-2 mt-4 items-start font-normal capitalize text-gray-400 dark:text-gray-500 ${
                    theme === "dark" ? "claro" : "oscuro"
                  }`}
                >
                  <svg viewBox="0 0 512 512" fill="currentColor" height="1.2em" width="1.2em" className="min-w-[1.2em] mt-1.5">
                ...
                <time>
                  <div
                    className={`flex flex-row gap-x-2 font-normal capitalize text-gray-400 dark:text-gray-500 ${
                      theme === "dark" ? "claro" : "oscuro"
                    }`}
                  >
                    <svg viewBox="0 0 448 512" fill="currentColor" height="1em" width="1em" className="min-w-[1.2em] mt-1">
                ...
                <time
                  className={`flex flex-row gap-x-2 font-normal capitalize text-gray-400 dark:text-gray-500 ${theme === "dark" ? "claro" : "oscuro"}`}
                >
                  <svg viewBox="0 0 384 512" fill="currentColor" height="1em" width="1em" className="min-w-[1.2em] mt-1.5">
        ...
        <div className=" sm:pl-14 my-6 mx-10 pb-12">
          <ol className="relative border-l border-gray-200 dark:border-gray-700">
            {cursos.map((estudio, index) => (
              <li key={index} className="mb-24 ml-6">
                ...
                <h3 className="flex items-center text-lg font-black">
                  ...
                  {estudio?.estado && (
                    <span className="bg-yellow-100 text-center text-white text-tiny font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-yellow-900 dark:text-blue-300 ml-3">
                      Activo actualmente
                    </span>
                  )}
                </h3>
                ...
                <time
                  className={`flex flex-row gap-x-2 mt-6 font-normal text-gray-400 dark:text-gray-500 items-start ${
                    theme === "dark" ? "claro" : "oscuro"
                  }`}
                >
                  <svg viewBox="0 0 512 512" fill="currentColor" height="1em" width="1em" className="min-w-[1em] mt-1.5">
                    <path d="M256 370.43L96 279v98.42l160 88.88 160-88.88V279l-160 91.43z" />
                    <path d="M512.25 192L256 45.57-.25 192 256 338.43l208-118.86V384h48V192.14l.25-.14z" />
                  </svg>
                  {estudio?.lugar ?? "Lugar no disponible actualmente"}
                ...
                <time>
                  <div className="flex flex-row gap-x-2 mb-1 font-normal text-gray-400 dark:text-gray-500">
                    <svg viewBox="0 0 448 512" fill="currentColor" height="1em" width="1em" className="min-w-[1em] mt-1">
                      <path d="M152 64h144V24c0-13.25 10.7-24 24-24s24 10.75 24 24v40h40c35.3 0 64 28.65 64 64v320c0 35.3-28.7 64-64 64H64c-35.35 0-64-28.7-64-64V128c0-35.35 28.65-64 64-64h40V24c0-13.25 10.7-24 24-24s24 10.75 24 24v40zM48 248h80v-56H48v56zm0 48v64h80v-64H48zm128 0v64h96v-64h-96zm144 0v64h80v-64h-80zm80-104h-80v56h80v-56zm0 216h-80v56h64c8.8 0 16-7.2 16-16v-40zm-128 0h-96v56h96v-56zm-144 0H48v40c0 8.8 7.16 16 16 16h64v-56zm144-216h-96v56h96v-56z" />
                    </svg>
                ...
                <time
                  className={`flex flex-row gap-x-2 mb-4  font-normal capitalize text-gray-400 dark:text-gray-500 ${
                    theme === "dark" ? "claro" : "oscuro"
                  }`}
                >
                  <svg viewBox="0 0 384 512" fill="currentColor" height="1em" width="1em" className="min-w-[1em] mt-1.5">
                    <path d="M215.7 499.2C267 435 384 279.4 384 192 384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2 12.3 15.3 35.1 15.3 47.4 0zM192 256c-35.3 0-64-28.7-64-64s28.7-64 64-64 64 28.7 64 64-28.7 64-64 64z" />
                  </svg>
                  {estudio?.ubicacion ?? "Ubicación no disponible actualmente"}
                </time>
